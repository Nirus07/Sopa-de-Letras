...
class Dificultades(tk.Tk):
    ...
    def abrir_Ventana(self):
        ...
        for texto_Dificultad,metodo_Dificultad in self.botones:
            ...
            self.boton_Dificultad = tk.Button(self,text=texto_Dificultad,width=20,bg="#000C3D",fg="#49FDA9",command=lambda texto=texto_Dificultad: metodo_Dificultad(texto),
                                              font=("Arial",20,"bold"))
        ...
        self.boton_Regresar = tk.Button(self,width=20,text="Regresar",font=("Arial",20,"bold"),bg="#000C3D",fg="#49FDA9",
    ...
    def seleccion_Dificultad(self,texto):
        self.destroy()
        if(texto == "Principiante"):
            Sopa_De_Letras(12,12)
        elif(texto == "Intermedia"):
            Sopa_De_Letras(20,20)
        elif(texto == "Avanzada"):
            Sopa_De_Letras(28,28)
